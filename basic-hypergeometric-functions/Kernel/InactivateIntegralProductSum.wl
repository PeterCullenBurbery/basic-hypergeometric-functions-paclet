...
InactivateIntegralProductSum[input_] :=
    ReleaseHold[ReplaceAll[{Integrate -> Inactive[Integrate], Product
         -> Inactive[Product], Sum -> Inactive[Sum]}][PeterBurbery`BasicHypergeometricFunctions`MakeFunctionsExact @ PeterBurbery`BasicHypergeometricFunctions`RemoveNumericalFunctionOptions[
        EnsureHeld[input]]]]
