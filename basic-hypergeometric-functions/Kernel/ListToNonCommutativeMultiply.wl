...
ListToNonCommutativeMultiply[l_?ListQ] := 
 Which[Length[l] === 1, First[l], 1 < Length[l], 
  NonCommutativeMultiply @@ l, Length[l] === 0, 1]


ListToNonCommutativeMultiply[args___]:=Null/;CheckArguments[ListToNonCommutativeMultiply[args],1]
  End[]
  EndPackage[]