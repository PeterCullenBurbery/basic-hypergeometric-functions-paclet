...
(* SetAttributes[RearrangedExpressionLaTeX, {HoldAllComplete}]
RearrangedExpressionLaTeX[input_ ] :=Unevaluated[input] *)
    ...
    ][TeXString[Activate[ApplyTransformationsToExpression[Unevaluated[input]],Sum]]]] *)
