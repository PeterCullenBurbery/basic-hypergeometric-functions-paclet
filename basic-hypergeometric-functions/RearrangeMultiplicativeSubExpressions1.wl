...
PeterBurbery`BasicHypergeometricFunctions`RearrangeMultiplicativeSubExpressions1;

Begin["`Private`"];

(* Define your public and private symbols here. *)
RearrangeMultiplicativeSubExpressions1//ClearAll
Attributes[
  RearrangeMultiplicativeSubExpressions1] = {HoldFirst}
RearrangeMultiplicativeSubExpressions1[input_] := 
 Module[{firstoutput}, 
firstoutput = 
  Inactivate[input, 
